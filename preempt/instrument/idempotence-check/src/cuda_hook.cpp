...
HOOK_C_API HOOK_DECL_EXPORT CUresult cuLaunchKernel(CUfunction f, unsigned int gridDimX, unsigned int gridDimY,
    ...
    enter_kernel_launch(f, gridDimX, gridDimY, gridDimZ, blockDimX, blockDimY, blockDimZ, hStream, kernelParams);

    CUresult ret = func_entry(f, gridDimX, gridDimY, gridDimZ, blockDimX, blockDimY, blockDimZ,
